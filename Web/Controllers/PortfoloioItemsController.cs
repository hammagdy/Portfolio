...
{
    public class PortfoloioItemsController : Controller
    {
        private readonly IUnitOfWorkT<PortfoloioItem> _portfolio;
        private readonly IHostingEnvironment _hosting;

        public PortfoloioItemsController(IUnitOfWorkT<PortfoloioItem> portfolio, IHostingEnvironment hosting)
        {
        ...
        public async Task<IActionResult> Create(portfolioviewmodel model)
        {
            if (ModelState.IsValid)
            {
                ...
                PortfoloioItem portfolioItem = new PortfoloioItem
                {
